...
async def display_results(
    ...
    for result in response.objects:
        ...
        recreated_round = alloy.EncryptedField(encrypted_field=base64.b64decode(result.properties["round"]), secret_path=secret_path, derivation_path=derivation_path)  # type: ignore
