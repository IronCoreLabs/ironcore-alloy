use super::standard::{decrypt_aes_edek, derive_aes_encryption_key, StandaloneStandardClient};
use crate::{
    errors::AlloyError,
...
use ironcore_documents::{
    aes::{self, decrypt_document_with_attached_iv},
...
pub fn encrypt_field_attached<U: AsRef<[u8]>, R: RngCore + CryptoRng>(
    ...
    let attached_payload = aes::encrypt_document_and_attach_iv(
        rng,
        aes_dek,
